...
import com.zmj.mvc.example.base.IBaseView;
...
public abstract class BaseFragment extends Fragment implements IBaseView{
    ...
    protected void setBaseView(@Nullable LayoutInflater inflater, @LayoutRes int layoutId){
    ...
    public void onDestroyView() {
        ...
        if (mContentView != null){
            ((ViewGroup)mContentView).removeView(mContentView);
        }
        super.onDestroyView();
    }
